...
from nemo.collections.llm.recipes.agi_e128 import pretrain_recipe
...
def override_recipe_configs(
    ...
    recipe = set_exp_logging_configs(
        recipe, "pre_train", "llm", "agi", args.tensorboard, args.wandb, args.wandb_prj_name, args.wandb_job_name
    )
...
if __name__ == "__main__":
    ...
    kwargs = get_user_configs(args.gpu.lower(), "pre_train", "agi", "e128", args)
